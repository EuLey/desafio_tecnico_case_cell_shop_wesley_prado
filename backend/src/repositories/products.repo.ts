...
const SEED: Product[] = [
  { id: 'cap-iphone-15', name: 'Capa iPhone 15 - Silicone Preta', price: 89.9, stock: 10 },
  { id: 'cap-galaxy-s24', name: 'Capa Galaxy S24 - Transparente', price: 59.9, stock: 1 },
  { id: 'cap-pixel-9', name: 'Capa Pixel 9 - Couro Caramelo', price: 129.9, stock: 0 },
]
